...
/**
 * Created by Tjitte Bouma on 1/12/2017.
 */
public class WillekeurigeData {
    ...
    /**
     * In deze method wordt een kop of munt teruggegeven, voor velden waar 2 opties mogelijk zijn (bijv. Geslacht).
     * @return kop of munt.
     */
    public static String kopOfMunt() {
        String kopOfMunt="kop";
        double doubleGetal = 2 * Math.random();
        if (doubleGetal>1) { kopOfMunt="munt"; }
        return kopOfMunt;
    }
}
